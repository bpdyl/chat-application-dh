...
from core.consumers import GroupChatConsumer, PrivateChatConsumer, ThreadListUpdateConsumer,IndividualConsumer
websocket_urlPattern = [
    ...
    re_path(r'ws/a_&_i/(?P<uid>\w+)/$',IndividualConsumer.as_asgi()),#for active inactive status of user
